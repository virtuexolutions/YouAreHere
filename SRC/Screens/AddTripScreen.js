...
const AddTripScreen = props => {
  ...
  const [tripTripList, setTripListModalVisible] = useState(false);
  ...
  const getCityAndCountry = async () => {
    ...
    try {
      ...
      if (result.results.length > 0) {
        ...
        console.log(
          '🚀 ~ getCityAndCountry ~ placeDetailsUrl:',
          placeDetailsUrl,
        );
        ...
        if (
          placeResult.result &&
          placeResult.result.photos &&
          placeResult.result.photos.length > 0
        ) {
          const photoReference = placeResult.result.photos[0].photo_reference;
          console.log(
            '🚀 ~ getCityAndCountry ~ photoReference:',
            photoReference,
          );
          ...
          <View style={styles.main_view}>
            <View
              ...
              <CustomText
                ...
                {' Select List where you want to added your trip'}
              </CustomText>
              <TouchableOpacity
                onPress={() => setTripListModalVisible(!tripTripList)}
                style={[
                  styles.birthday,
                  {
              ...
              <TouchableOpacity
                ...
                {country && (
                  <CustomText
                    ...
                    {selectedCities ? `${selectedCities}` : 'select City'}
                  </CustomText>
                )}
                <Icon
                  name={'keyboard-arrow-down'}
          ...
          <View style={styles.cities_card}>
            <View
              ...
              <Icon
                ...
                size={moderateScale(25, 0.6)}
                color={Color.black}
                onPress={() => setTripListModalVisible(false)}
              />
            </View>
            <TextInputWithTitle
            ...
            <FlatList
              data={tripList}
              ListEmptyComponent={
                <CustomText style={styles.emphty_text}>
