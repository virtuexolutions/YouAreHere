...
const TripCards = ({
  ...
  // console.log('🚀 ~ TripCards ~ item:', item?.cities[0]?.places[0]
  // );
...
onPress={
  onPress
    ...
    : () =>
        ...
        <View
          ...
          <CustomImage
            ...
            source={
              image
                ? {uri: image}
                : item?.cities[0]?.places[0]?.image
                ? {uri: item?.cities[0]?.places[0]?.image}
        ...
        <Icon
          name={isfav === true ? 'favorite' : 'favorite-border'}
        ...
        <View style={styles.text_view}>
          <CustomText isBold style={styles.heading}>
            {trip_name ? trip_name : item?.trip_name}
          </CustomText>
          <View style={styles.text_view}>
            <Icon
              as={AntDesign}
              ...
              color={Color.yellow}
            />
            <CustomText style={styles.rating_text}>
